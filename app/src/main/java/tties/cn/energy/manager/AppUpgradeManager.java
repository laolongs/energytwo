package tties.cn.energy.manager;
...
public class AppUpgradeManager {
    ...
    private String apkName = AppUtils.getAppName();
    //apk下载文件的路径
    private String downloadApkPath;
    //   服务器返回的版本信息
    private Versionbean latestVersion;

    public AppUpgradeManager(Context context, Versionbean version) {
    ...
    public static AppUpgradeManager getInstance(Context context, Versionbean version) {
    ...
    public void startDown() {
        ...
        long downloadTaskId = AppUtils.getDownLoad();
        ...
        cur.close();
        DownloadManager.Request task = new DownloadManager.Request(Uri.parse(latestVersion.getUrl()));
        //定制Notification的样式
        String title = "正在下载:" + AppUtils.getAppName() + " " + latestVersion.getVersionName();
        task.setTitle(title);
        task.setDescription(latestVersion.getDescription());
        ...
        AppUtils.saveDownLoad(downloadTaskId);
