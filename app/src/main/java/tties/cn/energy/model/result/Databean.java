...
public class Databean {
    private List<DataFragmentbean.DataListBean> dataList;

    public List<DataFragmentbean.DataListBean> getDataList() {
        return dataList;
    }

    public void setDataList(List<DataFragmentbean.DataListBean> dataList) {
