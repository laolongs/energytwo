...
public class PtrClassicFoot extends FrameLayout implements PtrUIHandler { //实现接口
    private ImageView mPush;
    private TextView mTitleTextView;
    //在代码创建对象
    public PtrClassicFoot(Context context) {
        super(context);
        initView();
    }
    public PtrClassicFoot(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    public PtrClassicFoot(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        mTitleTextView = (TextView) header.findViewById(R.id.header_tv);
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            ...
            mTitleTextView.setText("正在加载新内容");
        }
    }
