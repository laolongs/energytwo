 ...
 * author chensi
 */
public class LineDataThreeChart extends  LineChart {

    public LineDataThreeChart(Context context) {
        super(context);
        setStyle();
    }

    public LineDataThreeChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        setStyle();
    }

    public LineDataThreeChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    public LineDataSet setDataSet1(ArrayList<Entry> values, String label) {
        LineDataSet set = new LineDataSet(values, label);
        int color = Color.parseColor("#F7A750");
        //设置点击交点后显示交高亮线的颜色
...
//        set.setFillColor(Fillcolor);
    ...
    public LineDataSet setDataSet2(ArrayList<Entry> values, String label) {
        LineDataSet set = new LineDataSet(values, label);
        set.setLabel(label);
        int color = Color.parseColor("#20F248");
        //设置点击交点后显示交高亮线的颜色
        int HighLightcolor = Color.parseColor("#F8A45E");
//        int Fillcolor = Color.parseColor("#FEE8D6");
        //设置线条的颜色
...
//        set.setFillColor(Fillcolor);
    ...
    public LineDataSet setDataSet3(ArrayList<Entry> values, String label) {
        LineDataSet set = new LineDataSet(values, label);
        int color = Color.parseColor("#E22E2D");
        //设置点击交点后显示交高亮线的颜色
        int HighLightcolor = Color.parseColor("#F8A45E");
//        int Fillcolor = Color.parseColor("#FEE8D6");
        //设置线条的颜色
