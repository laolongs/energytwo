 ...
 * author chensi
 */
public class LineDataTwoChart extends  LineChart {

    public LineDataTwoChart(Context context) {
        super(context);
        setStyle();
    }

    public LineDataTwoChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        setStyle();
    }

    public LineDataTwoChart(Context context, AttributeSet attrs, int defStyle) {
